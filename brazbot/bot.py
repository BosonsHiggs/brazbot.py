...
class DiscordBot:
	...
	# Função para atualizar dados no cache (sem alterar a validade)
	...
	async def start(self):
		asyncio.create_task(self._cache_cleanup_task()) # Start cache scan every 120 seconds
		await self.setup_hook() # Event method that starts only once
